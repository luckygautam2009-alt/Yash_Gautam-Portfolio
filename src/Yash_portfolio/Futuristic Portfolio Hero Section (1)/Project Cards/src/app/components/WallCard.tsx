    ...
    <div className="relative" style={{ perspective: "900px" }}>
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            boxShadow: `0 3px 10px ${project.pinColor}99, 0 1px 4px rgba(0,0,0,0.25)`,
          }}
        />
        {/* Pin shaft */}
        <div
      ...
      >
        ...
        >
            ...
            <motion.span
              ...
              animate={
                hovered
                  ...
                  : { scale: 1, y: 0, rotate: 0, filter: "drop-shadow(0 0px 0px transparent)" }
              }
          ...
          >
            {project.liveUrl && (
              <ActionButton href={project.liveUrl} variant="primary">
                <ExternalLink size={11} strokeWidth={2.5} />
                View Project
              </ActionButton>
            )}
            {project.sourceUrl && (
              <ActionButton href={project.sourceUrl} variant="ghost">
