...
function Particle({ delay }: { delay: number }) {
  const colors = ["#8b5a2b", "#b87d4b", "#d4a373", "rgba(139,90,43,0.5)"];
...
export function BeyondTheCode() {
  ...
  return (
    ...
    >
      ...
      <div id="skills-section" className="absolute top-0 left-0 w-full h-1 pointer-events-none" />
      <div id="services-section" className="absolute top-1/2 left-0 w-full h-1 pointer-events-none" />

      {/* Light warm frosted ambient overlay */}
      <div
        style={{
          position: "absolute",
          inset: 0,
      ...
      >
        ...
        >
          ...
          <br />
          <span style={{ color: "#8b5a2b", fontWeight: 700 }}>
          ...
          return (
            ...
            >
              <div style={{ width: "100%", height: "100%" }}>
                <div
                  style={{
                    borderRadius: isHov ? "20px" : "50%",
                    background: isHov
                      ? "rgba(255,255,255,0.92)"
                      : "rgba(255,255,255,0.65)",
                    backdropFilter: "blur(16px)",
                    WebkitBackdropFilter: "blur(16px)",
                    border: `2px solid ${isHov ? node.color : "rgba(255,255,255,0.8)"}`,
                    boxShadow: isHov
                      ? `0 8px 32px ${node.border}, 0 12px 48px rgba(139,90,43,0.12)`
                      : `0 4px 16px rgba(139,90,43,0.08)`,
                    padding: isHov ? "16px 18px" : "12px",
                    width: isHov
                      ? "clamp(160px,18vw,200px)"
                      : "clamp(90px,10vw,116px)",
                    minHeight: isHov ? "auto" : "clamp(90px,10vw,116px)",
                    display: "flex",
                    flexDirection: "column",
                    alignItems: "center",
                    justifyContent: "center",
                ...
                >
                  <span
                    style={{
                      fontSize: isHov ? "24px" : "clamp(22px,2.6vw,30px)",
                      display: "block",
                      marginBottom: isHov ? "6px" : "4px",
                  ...
                  <div
                    style={{
                      fontSize: isHov ? "12px" : "clamp(8.5px,0.9vw,11px)",
                      fontWeight: 800,
                      color: isHov ? node.color : "#2d1f10",
                      textTransform: "uppercase",
          ...
          {[0, 1, 2].map((i) => (
            <div
              ...
              style={{
                ...
                background:
                  i === 1
                    ? "linear-gradient(90deg, #8b5a2b, #d4a373)"
                    : "rgba(139,90,43,0.3)",
              }}
            />
          ))}
      ...
      <style>{`
        ...
        @keyframes btcCorePulse {
          0%, 100% { box-shadow: 0 0 28px rgba(139,90,43,0.2), 0 0 60px rgba(212,163,115,0.1); }
          50%       { box-shadow: 0 0 44px rgba(139,90,43,0.35), 0 0 90px rgba(212,163,115,0.2); }
        }
