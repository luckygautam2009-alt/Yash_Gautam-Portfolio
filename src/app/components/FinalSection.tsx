  ...
  return (
    <motion.div
      ...
      style={{
        ...
        background: gradient,
        boxShadow: `0 ${size * 0.08}px ${size * 0.3}px rgba(139,90,43,0.14), inset 0 ${size * 0.06}px ${size * 0.15}px rgba(255,255,255,0.55)`,
    ...
    <div className="relative flex items-center justify-center flex-shrink-0" style={{ width: 320, height: 320 }}>
      ...
      <motion.div
        ...
        style={{
          ...
          background: "radial-gradient(circle, rgba(212,163,115,0.35) 0%, rgba(139,90,43,0.2) 50%, transparent 80%)",
          filter: "blur(22px)",
        }}
        ...
        <div className="text-center z-10 px-4 select-none">
          ...
          <motion.div
            style={{
              ...
              background: "radial-gradient(circle, #8b5a2b, #d4a373)",
              margin: "0.4rem auto 0",
              boxShadow: "0 0 8px rgba(139,90,43,0.8)",
            }}
      ...
      {/* micro-orbs */}
      {[
        { size: 16, orbit: 108, color: "radial-gradient(circle at 35% 30%, rgba(255,255,255,0.9), #8b5a2b)", dur: 6 },
        { size: 11, orbit: 122, color: "radial-gradient(circle at 35% 30%, rgba(255,255,255,0.9), #d4a373)", dur: 9 },
        { size: 9,  orbit: 100, color: "radial-gradient(circle at 35% 30%, rgba(255,255,255,0.9), #b87d4b)", dur: 7 },
      ].map((o, i) => (
        <motion.div
          key={i}
          className="absolute rounded-full"
          style={{
            ...
            background: o.color,
            boxShadow: `0 2px 8px rgba(139,90,43,0.3), inset 0 1px 2px rgba(255,255,255,0.8)`,
            top: "50%", left: "50%",
            marginTop: -o.size / 2,
            marginLeft: -o.size / 2,
...
const contacts = [
  {
    ...
    accent: "#8b5a2b",
    accentDark: "#704720",
    bg: "linear-gradient(135deg, rgba(244,227,211,0.5) 0%, rgba(244,227,211,0.15) 100%)",
  ...
  },
  {
    ...
    accent: "#704720",
    accentDark: "#5a3818",
    bg: "linear-gradient(135deg, rgba(250,237,205,0.5) 0%, rgba(250,237,205,0.15) 100%)",
  ...
  },
  {
    ...
    accent: "#b87d4b",
    accentDark: "#8b5a2b",
    bg: "linear-gradient(135deg, rgba(245,208,168,0.5) 0%, rgba(245,208,168,0.15) 100%)",
  ...
  },
  {
    ...
    accent: "#d4a373",
    accentDark: "#704720",
    bg: "linear-gradient(135deg, rgba(249,198,160,0.5) 0%, rgba(249,198,160,0.15) 100%)",
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden z-0">
        <motion.div
          style={{ position: 'absolute', top: '10%', left: '6%', color: '#8b5a2b', opacity: 0.035 }}
          animate={{ rotate: 360 }}
        ...
        <motion.div
          style={{ position: 'absolute', top: '35%', right: '8%', color: '#8b5a2b', opacity: 0.035 }}
          animate={{ y: [0, -15, 0] }}
        ...
        <motion.div
          style={{ position: 'absolute', bottom: '10%', right: '12%', color: '#8b5a2b', opacity: 0.035 }}
      ...
      <div className="relative z-10 flex flex-col items-center" style={{ paddingTop: "5.5rem" }}>
        ...
        <div className="w-full max-w-7xl mx-auto px-6 flex flex-col lg:flex-row items-center justify-between gap-12 mb-20">
          ...
          >
            ...
            <div style={{
              ...
              lineHeight: 1.12,
              letterSpacing: "-0.02em",
              background: "linear-gradient(135deg, #8b5a2b 0%, #704720 50%, #b87d4b 100%)",
            ...
            <div style={{
              ...
              <span style={{
                background: "linear-gradient(90deg, #8b5a2b, #b87d4b)",
                WebkitBackgroundClip: "text",
                WebkitTextFillColor: "transparent",
                backgroundClip: "text",
              }}>Idea.</span>
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              boxShadow: "0 8px 48px rgba(139,90,43,0.12), inset 0 2px 0 rgba(255,255,255,0.9)",
            }}
          >
        ...
        <div
          ...
          style={{
            background: "linear-gradient(180deg, transparent 0%, rgba(244,227,211,0.5) 60%, rgba(238,222,204,0.7) 100%)",
            paddingTop: "4rem",
            paddingBottom: "4rem",
          }}
        >
          ...
          <div style={{
            width: "55%",
            height: 1,
            background: "linear-gradient(90deg, transparent, rgba(139,90,43,0.4), rgba(212,163,115,0.4), transparent)",
            marginBottom: "3rem",
          }} />
